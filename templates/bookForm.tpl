    ...
    <div class="row">
        <div class="col-9">
            <div class="form-group">
                ...
                <label>Price</label>
                <input name="book_price" {if isset($book_id)}value="{$book[0]->book_price}"{/if} type="number" class="form-control w-50" required>
                <label>Category</label>
                <input name="book_category" {if isset($book_id)}value="{$book[0]->book_category}"{/if} type="text" class="form-control w-50" required>    
            </div>
        </div>
